...
const DISCIPLINE_METRICS: DisciplineMetric[] = [
  {
    ...
    metricValue: '4 attacks blocked',
    valueProtectedEarned: 120.0,
    accent: '#38BDF8',
    description: 'Calculated savings from frontrunning deflection and sandwich attack mitigation on BSC.',
    code: 'ALPHA.01',
  },
  {
    id: 'grid',
    ...
    metricValue: '18.4% APY localized',
    valueProtectedEarned: 84.5,
    accent: '#FF7828',
    description: 'Realized swap fee earnings from rebalanced tick positions during high volatility.',
    code: 'ALPHA.02',
  },
  {
    id: 'health_factor',
    ...
    metricValue: '100% solvency preserved',
    valueProtectedEarned: 350.0,
    accent: '#FF4365',
    description: 'Estimated loss prevented by auto-rebalancing collateral prior to liquidation trigger.',
    code: 'ALPHA.03',
  },
  {
    id: 'yield',
    ...
    metricValue: '12.8% net compounded',
    valueProtectedEarned: 45.2,
    accent: '#00F59B',
    description: 'Accrued returns from automated yield vault sweeping and optimal gas harvesting.',
    code: 'ALPHA.04',
  },
];
